...
def plot_global(nodes):
    ...
    for i in range(len(nodes)-1):
        ...
        plt.plot(nodes[i:i+2,1],nodes[i:i+2,2], ".r",markeredgewidth=5,markersize=10)
        plt.plot(nodes[i,1],nodes[i,2], ".w",markeredgewidth=5,markersize=10)
        plt.plot(nodes[i:i+2,3],nodes[i:i+2,4], "*g",markeredgewidth=5,markersize=10)
        plt.plot(nodes[i,3],nodes[i,4], "*w",markeredgewidth=5,markersize=10)
        plt.plot(nodes[i:i+2,5],nodes[i:i+2,6], "Db",markeredgewidth=5,markersize=5)
        plt.plot(nodes[i,5],nodes[i,6], "Dw",markeredgewidth=5,markersize=5)
        if (nodes[i+1,1]==nodes[i,1] and (nodes[i+1,2]==nodes[i,2])):
            plt.plot(nodes[i+1,1],nodes[i,2], ".r",markeredgewidth=5,markersize=10)

        if (nodes[i+1,3]==nodes[i,3] and (nodes[i+1,4]==nodes[i,4])):
            plt.plot(nodes[i+1,3],nodes[i,4], "*g",markeredgewidth=5,markersize=10)

        if (nodes[i+1,5]==nodes[i,5] and (nodes[i+1,6]==nodes[i,6])):
            plt.plot(nodes[i+1,5],nodes[i,6], "Db",markeredgewidth=5,markersize=5)
...
def obstacle_space(start,goal):
    ...
    if show_animation:
        ...
        plt.plot(goal[0,0], goal[0,1], "+r",markeredgewidth=10,markersize=10)
        plt.plot(start[1,0], start[1,1], "^r")
        plt.plot(goal[1,0], goal[1,1], "+g",markeredgewidth=10,markersize=10)
        plt.plot(start[2,0], start[2,1], "^r")
        plt.plot(goal[2,0], goal[2,1], "+b",markeredgewidth=10,markersize=10)
        plt.grid(True)
        plt.axis("equal")
    return obs_x,obs_y
